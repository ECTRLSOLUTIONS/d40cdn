...
//			this.jsonParams.pag = this.filterConfig.currentPage;
			...
			if(this.docs.length==0 && this.filterConfig.currentPage>1 ) {
				this.jsonParams.num = (this.filterConfig.currentPage-1)*this.filterConfig.pageSize+parseInt(this.filterConfig.pageSize);
				this.jsonParams.pag=1;
			}

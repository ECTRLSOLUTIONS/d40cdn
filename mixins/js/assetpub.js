var d40_asset_pub = {
    ...
    methods: {
        ...
        fetchData: function () {
            ...
            this.filter.jsonParams.structureKey = this.filter.filterConfig.structureKey;
            this.filter.jsonParams.f0 = this.filter.filterConfig.f0;
            this.filter.jsonParams.f1 = this.filter.filterConfig.f1;
            this.filter.jsonParams.c1 = this.filter.filterConfig.c1;
            this.filter.jsonParams.queryAndOperator0 = this.filter.filterConfig.queryAndOperator0;
            this.filter.jsonParams.queryAndOperator1 = this.filter.filterConfig.queryAndOperator1;
            this.filter.jsonParams.queryAndOperatorC1 = this.filter.filterConfig.queryAndOperatorC1;
            this.filter.jsonParams.orderByColumn1 = this.filter.filterConfig.orderByColumn1;
            this.filter.jsonParams.orderByType1 = this.filter.filterConfig.orderByType1;
            this.filter.jsonParams.orderByColumn2 = this.filter.filterConfig.orderByColumn2;
            this.filter.jsonParams.orderByType2 = this.filter.filterConfig.orderByType2;
